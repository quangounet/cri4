...
for i in xrange(0,8):
    ...
    controlVF.append(VF_Var[i+8])
    controlBF.append(BF_Var[i+8])
    controlMTS.append(VFBF_Var[i+8])
...
ax.set_xticklabels(('PC4E','PC4N','PC4S','PC4W','PC5E','PC5N','PC5S','PC5W','CC4E','CC4N','CC4S','CC4W','CC5E','CC5N','CC5S','CC5W'))
...
ax.set_xticklabels(('C4E','C4N','C4S','C4W','C5E','C5N','C5S','C5W'))
ax.legend((pVF[0],cVF[0]),('MTD-patient','MTD-control'))
...
ax.set_xticklabels(('C4E','C4N','C4S','C4W','C5E','C5N','C5S','C5W'))
ax.legend((pBF[0],cBF[0]),('MTD-patient','MTD-control'))
...
ax.set_xticklabels(('C4E','C4N','C4S','C4W','C5E','C5N','C5S','C5W'))
ax.legend((pMTS[0],cMTS[0]),('MTD-patient','MTD-control'))
...
for i in xrange(0,8):
    ...
    MTD_Data[1][0].append(VF_Var[i+8])
    MTD_Data[1][1].append(BF_Var[i+8])
