            ...
            for k in xrange(0,len(use_files[j])):
                ...
                for l in xrange(0, len(time_vel[j][k])):
                    ...
                    if (i==13 or i==17) and n>0.24:
                        break
                    if n>0.4 and (i!=11 or j!=1) and (i in velcutlow):
                        break
                    if n>0.5 and (i!=11 or j!=1) and (i in velcutmed):
                        break
                    if n>0.7 and (i!=11 or j!=1) and (i in velcuthi):
                        break
...
f1.savefig("/home/cuebong/git/cri4/Trajectory_Plots/Combined/lol2trajectory_plots_"+target_list[j])
plt.close()
...
f2.savefig("/home/cuebong/git/cri4/Trajectory_Plots/Velocity_Plots/lol2velocity_profiles_"+target_list[j])
plt.close()
