            ...
            for k in xrange(0,len(use_files[j])):
                ...
                for l in xrange(0, len(time_vel[j][k])):
                    ...
                    if i==6 and j==28 and n>0.6:
                        break
                    if (i==13 or i==17) and n>0.3:
                        break
                    if n>0.4 and ((i!=11 or j!=37) and (i!=11 or j!=20) and (i!=76 or j!=20) and (i!=6 or j!=5) and (i!=19 or j!=28) and (i!=6 or j!=28)):
                        break
